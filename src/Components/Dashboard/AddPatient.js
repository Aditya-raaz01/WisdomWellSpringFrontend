    ...
    return(
        <>
            <div id="dashboard">
                ...
                <div id="display">
                    <img src='/pictures/addPatientBackImage.jpg' alt="" id="addPatientBackImage"/>
                </div>
            </div>
            <div id="addPatientForm">
              ...
              <input type='text' placeholder='Name' id='patientName' name='patientName' value={patientName} onChange={(e)=>{
                    ...
                    <select id="patientListGender" name='patientGender' value={patientGender} onChange={(e)=>{
                        ...
                        <option id="patientGenderBox" value="Male">Male</option>
                        <option id="patientGenderBox" value="Female">Female</option>
                    </select>
                    <br/>
                    <input type='number' placeholder='Age' id='patientAge' name='patientAge' value={patientAge} onChange={(e)=>{
                        setpatientAge(e.target.value)
                    }}></input><br/>
                    <input type='text' placeholder='PhoneNumber' id='patientNumber' name='patientNumber' value={patientNumber} onChange={(e)=>{
