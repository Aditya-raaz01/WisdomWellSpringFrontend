        ...
        <>
            ...
            <div id="addMedicineForm">
              ...
              <input type='text' placeholder='Medicine Name' id='medicineName' name='medicineName' value={medicineName} onChange={(e)=>{
                    ...
                    <select id="medicineTimeList" name='medicineTime' value={medicineTime} onChange={(e)=>{
                        setMedicineTime(e.target.value)}}>
                        <option id="medicineTimeBox" value="Morning">Morning</option>
                        <option id="medicineTimeBox" value="Afternoon">Afternoon</option>
                        <option id="medicineTimeBox" value="Evening">Evening</option>
                        <option id="medicineTimeBox" value="Night">Night</option>


                    </select>
                    <br/>
                    <span id='medicineFood'>Medicine Food Timing: </span>
                    <select id="medicineFoodList" name='medicineFood' value={medicineFoodBox} onChange={(e)=>{
